        ...
        <Section className="relative flex min-h-[calc(100vh-4rem)] flex-col justify-center py-12 sm:py-16">
          <div className="mx-auto grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="text-center lg:text-left">
              <div className="mb-6 inline-flex items-center gap-3 rounded-[22px] border border-[var(--ca-border)] bg-white/80 py-1.5 pl-1.5 pr-4 text-xs font-semibold text-[var(--ca-ink-muted)] shadow-[var(--ca-shadow-soft)] backdrop-blur">
                <BrandLogo size={48} priority />
                <span className="text-left leading-tight">
                  <span className="block text-[11px] font-extrabold tracking-tight text-[var(--ca-ink)]">
                    Cyber Alert DRC
                  </span>
                  <span className="block text-[10px] font-medium">McBuleli AI · aperçu du lien</span>
                </span>
              </div>
            ...
            <SurfaceCard variant="panther" className="relative hidden overflow-hidden p-6 lg:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-xl font-bold text-white">Risque + aperçu McBuleli AI</h2>
                </div>
              </div>
